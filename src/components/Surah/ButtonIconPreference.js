import IconSetting from "../../assets/icons/IconAdjustments";

const ButtonIconPreference = ({ onClick }) => {
  return (
    <button
      onClick={onClick}
      className={`p-2 relative flex gap-2 group text-sm font-medium items-center justify-center hover:bg-yellow-400 transition rounded-lg`}
    >
